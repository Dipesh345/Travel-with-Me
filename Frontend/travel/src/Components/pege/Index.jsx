    ...
    <>
            ...
            <div className="col-lg-6 about-content-wrap">
              <div className="selection-title about-title">
                <div className="text-center d-flex flex-column align-items-start justify-content-start gap-3">
                  ...
                  <p>
                    Your gateway to curated travel experiences, top
                    destinations, and personalized adventures—designed to
                    inspire and simplify every journey.
                  </p>
                </div>
              </div>
          ...
          <SwiperSlide key={index}>
            ...
            >
              <div className="custom-offer-box animate-fade-in">
                ...
                <h1 className="custom-main-heading animated-heading">
                  {offer.heading}
                </h1>
                ...
                <div className="custom-location-price">
                  ...
                  <p className="price-text">
                    💸 Price after discount: {offer.price}
                  </p>
                </div>
                ...
                <div className="custom-discount">
                  <span className="custom-discount-number">
                    {offer.discount}
                  </span>
      ...
      <div className="testimonial py-5 position-relative">
        ...
        <img
          src={testBG}
          alt="img-testimonials"
          className="img-fluid test-img-2"
        />
        ...
        <div className="section-title test-title text-center">
          ...
          <p className="mt-2">
            We take pride in delivering exceptional experiences. Here's what our
            clients have to say about their journeys with us — real feedback
            from real people.
          </p>
        </div>
                  ...
                  <div className="col-lg-6">
                    <div className="test-content">
                      <img
                        src={quote}
                        alt="quote"
                        className="img-fluid test-content-img mb-3"
                      />
                      <p className="test-pare">
                        "From start to finish, the experience was seamless. The
                        attention to detail and professionalism truly exceeded
                        my expectations. I would highly recommend their service
                        to anyone looking for quality and care."
                      </p>
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6">
                    <div className="test-content">
                      ...
                      />
                      <p className="test-pare">
                        "An absolute pleasure working with this team. They
                        listened carefully to our needs and delivered above and
                        beyond. Their dedication to client satisfaction really
                        sets them apart."
                      </p>
                      <div className="test-stars mb-3">
                        <i className="bi bi-star-fill"></i>
                      ...
                      <div className="test-user d-flex align-items-center gap-3 mt-3">
                        ...
                        <div className="test-user-info">
                          ...
                          <p className="m-0">
                            Senior Developer at Sleeping studio
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6">
                    <div className="test-content">
                      ...
                      />
                      <p className="test-pare">
                        "Efficient, friendly, and incredibly responsive — I felt
                        heard and valued throughout the entire process. They
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6">
                    <div className="test-content">
                      ...
                      />
                      <p className="test-pare">
                        "I’ve collaborated with many teams before, but this one
                        truly stood out. Their creativity and commitment brought
                        our ideas to life better than we imagined."{" "}
                      </p>
                      <div className="test-stars mb-3">
                        <i className="bi bi-star-fill"></i>
                        <i className="bi bi-star-fill"></i>
            ...
            <div className="col-md-6">
              <div className="newsletter-highlight p-4 rounded-4 position-relative animate__animated animate__fadeInRight">
                <p className="mb-0 fs-5 text-dark">
                  ...
                  for the latest news and insightful blog posts.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="footer-sections">
            ...
            <div className="footer-column">
              ...
              <ul className="contact-list">
                <li>
                  <a
                    href="https://wa.me/9779862015811"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <i className="fab fa-whatsapp"></i> +977-9862015811
                  </a>
                </li>
                <li>
                  <a
                    href="https://wa.me/9779815014596"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <i className="fab fa-whatsapp"></i> +977-9815014596
                  </a>
                </li>
                <li>
                  <a href="mailto:travel299@gmail.com">
                    <i className="fas fa-envelope"></i> travel299@gmail.com
                  </a>
                </li>
              </ul>
            </div>
